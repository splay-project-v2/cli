...
<topology>
	...
	<edges>
		<edge int_idx="1" int_src="1" int_dst="2" specs="client-stub" dbl_kbps="8" />
		<edge int_idx="2" int_src="2" int_dst="1" specs="client-stub" />
	</edges>
	<specs>
		<client-stub dbl_plr="0" dbl_kbps="200" int_delayms="0" int_qlen="10" />
	</specs>
</topology>
]]--
